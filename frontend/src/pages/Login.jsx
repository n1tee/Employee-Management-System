...
const Login = () => {
  ...
  return (
    <div
        className="flex flex-col items-center h-screen justify-center bg-gradient-to-b from-teal-600 from-50% tog-gray-100 to-50% space-y-6"
    >
        <h2 className="font-roboto text-3xl text-white">Employee Management System</h2>
